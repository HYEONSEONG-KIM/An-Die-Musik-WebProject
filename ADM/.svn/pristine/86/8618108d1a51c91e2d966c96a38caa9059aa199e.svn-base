...
/**
 * Servlet implementation class PblSelectboxToUpServlet
 */
@WebServlet("/PblSelectboxToUp.do")
public class PblSelectboxToUpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private IPblService service = null;
    
    public PblSelectboxToUpServlet() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("performance/updatePerf.jsp");
