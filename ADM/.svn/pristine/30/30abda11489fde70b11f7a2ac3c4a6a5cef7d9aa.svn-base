...
public class FboardImageViewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String imagePath = "C:\\ddit\\MiddelProject\\workspace\\ADM\\WebContent\\images\\fboard";
//		String imagePath = "C:\\A_TeachingMaterial\\4.MiddleProject\\workspace\\ADM\\WebContent\\images\\fboard";	//이미지뷰 변경
