...
<div id = "par">
	...
	<hr> 
	  <div class="form-group">
	    ...
	    <div class="col-sm-5">
	      <input type="text" name="notice_title" style="width:600px" class="form-control" id="sub1" placeholder="제목을 입력하세요.">
	    </div>
	  </div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-5">
	      <textarea class="form-control" style="width:600px" name="notice_content" rows="35" id="cont1" placeholder="내용을 입력하세요."></textarea>
	    </div>
	  </div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-5">
			<input type="file" class="form-control" name="file" style="width:600px">
	    </div>
	  </div>
