...
<head>
 ...
 $(function(){
	 readqna = function(page){
			...
			$.ajax({
				...
				success : function(res){
					...
					code = '	<div id="top">';
					code +=	'	<h2 id="ch">Q&A</h2><i id = "plusqna" class="far fa-plus-square"></i>';
					code += '	<hr>';
					code += '	</div>';
					...
					$.each(res.datas, function(i, v){
						...
						code += '<tr>';
						code += '<td class="td1">' + v.rnum + '</td>';
						code += '<td><a href = "/ADM/QnaDetail.do?qna_code=' + v.code +'"class = "tt" >' + v.title + '</a></td>';
						code += '<td class="td1">' + v.date.substr(2, 9) + '</td>';
	 ...
	 $('#part3').on('click','#plusqna',function(){
			location.href = '<%=request.getContextPath()%>/qna/qna_index.jsp' ;
