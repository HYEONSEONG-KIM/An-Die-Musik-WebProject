...
<!--     <link rel="stylesheet" href="modus2/css/reset.css"> -->
<!--     <link rel="stylesheet" href="modus2/css/liststyle.css"> -->
<!--     <link rel="stylesheet" href="modus2/css/font-awesome.css"> -->
 				...
 				$.ajax({
					url : '<%=request.getContextPath()%>/FboardList.do',
 					...
 					success : function(res){
 						...
 						code += '	<div id="top">';
 						code +=	'	<p id="ch">자유 게시판</p>';
 						code += '	<hr>';
 						code += '	</div>';
 						code += '<table class="table table-hover">';
 						code += 	'<thead class="thead-head">';
 						code += 		'<tr>';
 					 	code += 			'<th width="60px;">번호</th>'; 
 					 	code += 			'<th width="250px;">제목</th>';
 					 	code += 			'<th width="70px;">날짜</th>';
 					 	code += 			'<th width="50px;">조회수</th>';
 						code += 		'</tr>';
 						code += 	'</thead>';
 						code += 		'<tbody>';
						...
						$.each(res.datas, function(i, v){
							...
							code += '<td class="td_no">' + v.rnum + '</td>';
 							code += '<td><a href = "/ADM/FboardDetail.do?fboard_code=' + v.code +'">' + v.title + '</a></td>';
 							code += '<td class="td_date">' + v.date.substr(0, 10) + '</td>';
 							code += '<td class="td_date">' + v.cnt + '</td>';
 							code += '</tr>';	
