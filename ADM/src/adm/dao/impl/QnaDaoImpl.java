...
public class QnaDaoImpl implements IQnaDao {
	...
	@Override
	public List<QnaVO> qnaAllList(String id) throws SQLException {
		return client.queryForList("qna.qnaAllList", id);
	}

	@Override
	public List<QnaVO> qnaList2(Map<String, Object> map) throws SQLException {
		return client.queryForList("qna.qnaList2", map);
